...
/* harmony import */ var _cadastro_concluido_cadastro_concluido_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cadastro-concluido/cadastro-concluido.component */ "./src/app/cadastro-concluido/cadastro-concluido.component.ts");
/* harmony import */ var _home_logada_home_logada_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./home-logada/home-logada.component */ "./src/app/home-logada/home-logada.component.ts");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./login/login.component */ "./src/app/login/login.component.ts");
/* harmony import */ var auth_guard__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! auth.guard */ "./auth.guard.ts");
...
const routes = [
    { path: '', pathMatch: 'full', component: _content_content_component__WEBPACK_IMPORTED_MODULE_3__["ContentComponent"] },
    { path: 'cadastro', component: _cadastro_cliente_cadastro_cliente_component__WEBPACK_IMPORTED_MODULE_4__["CadastroClienteComponent"] },
    { path: 'cadastro-completo', component: _cadastro_concluido_cadastro_concluido_component__WEBPACK_IMPORTED_MODULE_5__["CadastroConcluidoComponent"], canActivate: [auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
    { path: 'home-logada', component: _home_logada_home_logada_component__WEBPACK_IMPORTED_MODULE_6__["HomeLogadaComponent"], canActivate: [auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
...
/* harmony import */ var auth_guard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! auth.guard */ "./auth.guard.ts");
...
/* harmony import */ var _cadastro_cliente_cadastro_cliente_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./cadastro-cliente/cadastro-cliente.component */ "./src/app/cadastro-cliente/cadastro-cliente.component.ts");
/* harmony import */ var _home_logada_home_logada_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./home-logada/home-logada.component */ "./src/app/home-logada/home-logada.component.ts");
/* harmony import */ var _cadastro_concluido_cadastro_concluido_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./cadastro-concluido/cadastro-concluido.component */ "./src/app/cadastro-concluido/cadastro-concluido.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _cadastro_cliente_cadastro_cliente_component__WEBPACK_IMPORTED_MODULE_13__["CadastroClienteComponent"],
            _home_logada_home_logada_component__WEBPACK_IMPORTED_MODULE_14__["HomeLogadaComponent"],
            _cadastro_concluido_cadastro_concluido_component__WEBPACK_IMPORTED_MODULE_15__["CadastroConcluidoComponent"],
...
let CadastroClienteComponent = class CadastroClienteComponent {
    ...
    ngOnInit() {
        ...
        this.formCadastro.valueChanges.pipe().subscribe(res => {
            //console.log(res);
    ...
    cpfCheck(trial) {
        ...
        let E = "";
        A = A.replace(/[^\d]+/g, '');
        if (A == 0o0 || A == 111111111 || A == 222222222 || A == 333333333 || A == 444444444 || A == 555555555 || A == 666666666 || A == 777777777 || A == 888888888 || A == 99999999999) {
            B = false;
        }
        else if (A == 0o0 || A == 1111111111 || A == 2222222222 || A == 3333333333 || A == 4444444444 || A == 5555555555 || A == 6666666666 || A == 7777777777 || A == 8888888888 || A == 999999999999) {
            C = false;
        }
        else if (A == 0o0 || A == 11111111111 || A == 22222222222 || A == 33333333333 || A == 44444444444 || A == 55555555555 || A == 66666666666 || A == 77777777777 || A == 88888888888 || A == 9999999999999) {
            D = false;
        }
        if (B || C || D) {
            //alert("Realizando calculo")
            let c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, s1, s2;
    ...
    formCheck() {
        let nome = document.getElementById("NOME").value, cpf = document.getElementById("CPF").value, email = document.getElementById("EMAIL").value, telefone = document.getElementById("TEL").value, endereço = document.getElementById("ENDE").value, passe = 0;
        if (nome.length < 3) {
            passe += 1;
            document.getElementById("NOME").className = "form-control cadastro shadow-none err";
            setTimeout(() => { document.getElementById("NOME").className = "form-control cadastro shadow-none"; }, 1500);
        }
        if (!this.cpfCheck(cpf)) {
            passe += 1;
            document.getElementById("CPF").className = "form-control cadastro shadow-none err";
            setTimeout(() => { document.getElementById("CPF").className = "form-control cadastro shadow-none"; }, 1500);
        }
        if (!this.emailCheck(email)) {
            passe += 1;
            document.getElementById("EMAIL").className = "form-control cadastro shadow-none err";
            setTimeout(() => { document.getElementById("EMAIL").className = "form-control cadastro shadow-none"; }, 1500);
        }
        if (telefone.length <= 10) {
            passe += 1;
            document.getElementById("TEL").className = "form-control cadastro shadow-none err";
            setTimeout(() => { document.getElementById("TEL").className = "form-control cadastro shadow-none"; }, 1500);
        }
        if (endereço.length <= 5) {
            passe += 1;
            document.getElementById("ENDE").className = "form-control cadastro shadow-none err";
            setTimeout(() => { document.getElementById("ENDE").className = "form-control cadastro shadow-none"; }, 1500);
        }
        if (passe == 0) {
            this.valido = true;
        }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CadastroConcluidoComponent", function() { return CadastroConcluidoComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let CadastroConcluidoComponent = class CadastroConcluidoComponent {
    constructor(router) {
        this.router = router;
        this.Contador = 10;
    }
    ...
    temporizador() {
        ...
        document.getElementById("tempo").innerHTML = `${Contador} segundos`;
        if (Contador == 1) {
            document.getElementById("tempo").innerHTML = `${Contador} segundo`;
        }
        this.Contador -= 1;
...
CadastroConcluidoComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
CadastroConcluidoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-cadastro-concluido',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./cadastro-concluido.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/cadastro-concluido/cadastro-concluido.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./cadastro-concluido.component.css */ "./src/app/cadastro-concluido/cadastro-concluido.component.css")).default]
    })
...
let ContentComponent = class ContentComponent {
    ...
    ngOnInit() {
        const options = {
            ...
            strings: [
                'Blue Dragon juros Amigos',
                'Peça a portabilidade e venha ser Blue Dragon hoje mesmo',
        ...
        const typed = new typed_js__WEBPACK_IMPORTED_MODULE_2___default.a('.typing-element', options);
    }
...
let HeaderComponent = class HeaderComponent {
    constructor(fb, router, elementRef) {
        this.fb = fb;
        this.router = router;
    ...
    ngAfterViewInit() {
        window.addEventListener("resize", () => { this.SearchBerror(); });
    }
    ngOnInit() {
    ...
    Finder() {
        ...
        //email
        const emailDB = this.getCadastro['email'], emailL = this.formLogin.get('email').value;
        //cpf
        const cpfDB = this.getCadastro['cpf'], cpfL = this.formLogin.get('cpf').value;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HomeLogadaComponent", function() { return HomeLogadaComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let HomeLogadaComponent = class HomeLogadaComponent {
    constructor(router) {
        this.router = router;
...
HomeLogadaComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
HomeLogadaComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-home-logada',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./home-logada.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/home-logada/home-logada.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./home-logada.component.css */ "./src/app/home-logada/home-logada.component.css")).default]
    })
], HomeLogadaComponent);
...
module.exports = __webpack_require__(/*! C:\Users\weide\Desktop\Angular\Banco\Banco\src\main.ts */"./src/main.ts");
